...
This document provides the analysis from the [New York Times](https://www.nytimes.com) 
on-line article ["What Drives Gun Sales: Terrorism, Obama and Calls for Restrictions"](https://www.nytimes.com/interactive/2015/12/10/us/gun-sales-terrorism-obama-restrictions.html). The [R](https://www.r-project.org) code underlying the analysis is provided
in the [GitHub](https://github.com) repository [gunsales](https://github.com/NYTimes/gunsales) which contains the R package 
